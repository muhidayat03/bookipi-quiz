...
QuizCard.Loading = () => (
  <div
    data-testid="quiz-card-loading"
    className="bg-white border border-slate-200 rounded-xl shadow-card p-6 flex justify-between items-center gap-4"
  >
    <div className="animate-pulse flex-1 min-w-0">
      <div className="h-5 bg-slate-200 rounded w-1/2" />
      <div className="h-4 bg-slate-200 rounded w-3/4 mt-3" />
      <div className="h-3.5 bg-slate-200 rounded w-1/4 mt-3" />
    </div>
